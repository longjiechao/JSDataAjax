...
function createTableContentYear(table){
    var year = document.getElementById("tablaYear").value;
    for(i = 0; i<categorias["Años"].length; i++){
        if(categorias["Años"][i] == year){
                    var div = document.createElement("div");
        var tr, th, td, text;
